...
109 Rust crates · <!-- count:SKILLS -->69<!-- /count:SKILLS --> skills · <!-- count:HOOKS -->53<!-- /count:HOOKS --> hooks · <!-- count:AGENTS -->38<!-- /count:AGENTS --> agent manifests ·
<!-- count:BLOCKS -->84<!-- /count:BLOCKS --> substrate blocks · 11 install profiles (minimal → full).
...
<!-- count:AGENTS -->38<!-- /count:AGENTS --> agents + <!-- count:SKILLS -->69<!-- /count:SKILLS --> skills + <!-- count:HOOKS -->53<!-- /count:HOOKS --> hooks + nightly consolidation wired
