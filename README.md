...
109 Rust crates · <!-- count:SKILLS -->52<!-- /count:SKILLS --> skills · <!-- count:HOOKS -->55<!-- /count:HOOKS --> hooks · <!-- count:AGENTS -->37<!-- /count:AGENTS --> agent manifests ·
...
<!-- count:AGENTS -->37<!-- /count:AGENTS --> agents + <!-- count:SKILLS -->52<!-- /count:SKILLS --> skills + <!-- count:HOOKS -->55<!-- /count:HOOKS --> hooks + nightly consolidation wired
