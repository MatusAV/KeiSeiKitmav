...
109 Rust crates · <!-- count:SKILLS -->52<!-- /count:SKILLS --> skills · <!-- count:HOOKS -->53<!-- /count:HOOKS --> hooks · <!-- count:AGENTS -->37<!-- /count:AGENTS --> agent manifests ·
<!-- count:BLOCKS -->83<!-- /count:BLOCKS --> substrate blocks · 11 install profiles (minimal → full).
...
<!-- count:AGENTS -->37<!-- /count:AGENTS --> agents + <!-- count:SKILLS -->52<!-- /count:SKILLS --> skills + <!-- count:HOOKS -->53<!-- /count:HOOKS --> hooks + nightly consolidation wired
