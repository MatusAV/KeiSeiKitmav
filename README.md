...
109 Rust crates · <!-- count:SKILLS -->69<!-- /count:SKILLS --> skills · <!-- count:HOOKS -->53<!-- /count:HOOKS --> hooks · <!-- count:AGENTS -->39<!-- /count:AGENTS --> agent manifests ·
...
<!-- count:AGENTS -->39<!-- /count:AGENTS --> agents + <!-- count:SKILLS -->69<!-- /count:SKILLS --> skills + <!-- count:HOOKS -->53<!-- /count:HOOKS --> hooks + nightly consolidation wired
